<%@ Page Title="Guniea Pig Care Advice" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GPCareAdvice.aspx.cs" Inherits="WebScriptingStartup.GPCareAdvice" %>
        ...
        <div class="col-sm-9">
            ...
            <table class="adviceTable" style="width:100%">
                ...
                <ItemTemplate>
                    <table class="adviceTable" style="width:100%">
                        <tr>
                            <td style="width:40%; height:50px"><a href="GPAdviceDetail.aspx?AdviceID=<%# Eval("Id") %>">&quot<%# Eval("Title") %>&quot</a></td>
                            ...
                            <td style="width:10%; height:50px"><a href="GPAdviceDetail.aspx?AdviceID=<%# Eval("Id") %>"><img src="<%# Eval("JPG")%>" width="50" height="50" /></a></td>
                        </tr>
                    </table>
                </ItemTemplate>
            </asp:Repeater>
