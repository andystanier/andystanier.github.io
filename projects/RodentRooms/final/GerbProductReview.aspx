<%@ Page Title="Gerbil Product Review" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GerbProductReview.aspx.cs" Inherits="WebScriptingStartup.GerbProductReview" %>
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            <div class="jmbtAnimal jumbotron">
                <h1>Gerbil Product Review</h1>
                <p class="lead">Products your Gerbil may need</p>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-sm-10">
                        <table class="productTable" style="width:100%">
                            <tr class="prodRow">
                                ...
                                <td rowspan="4" class="editProd"><div><a href="Users/editGerbProduct?ProdId=<%# Eval("Id") %>">Edit Product</a></div></td>
                            </tr>
                            <tr class="prodRow">    
                                <td>Supplier:</td>
